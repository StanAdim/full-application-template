...
const headers = ref(['Sn', 'Title', "Category" , "Year" , 'Registration Date', 'Approved', 'Actions'])
...
const handleAction = async  (type, uid) => {
  switch (type){
    case 1: {
      navigateTo(`/admin/projects/project/${uid}`)
      break;
    }
    case 2: {
      await adminStore.switchApprovalStatus('projects',uid)
      break;
    }
    case 3: {
