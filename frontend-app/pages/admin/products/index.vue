...
const headers = ref(['Sn', 'Name', "Category" ,"Is Launched", "Launched Date" ,  'Registration Date', 'Approved', 'Actions'])
...
const handleAction = async  (type, uid) => {
  switch (type){
    case 1: {
      navigateTo(`/admin/products/product/${uid}`)
      break;
    }
    case 2: {
      await adminStore.switchApprovalStatus('products',uid)
      break;
    }
    case 3: {
